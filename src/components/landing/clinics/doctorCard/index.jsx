  ...
  <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow">
    <div className="flex gap-4">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-gray-500 mb-2">Tajriba: {doctor.experience}</p>
      ...
      <button className="px-4 py-2 bg-green-600 text-white rounded-lg text-sm font-medium hover:bg-green-700 transition-colors h-fit whitespace-nowrap">
        Navbat olish
      </button>
    </div>
  </div>
