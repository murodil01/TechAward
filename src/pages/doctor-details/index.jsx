...
const DoctorDetail = () => {
  ...
  if (!doctor) {
    return (
      <div className="flex items-center justify-center h-[70vh]">
        <p className="text-xl text-red-500 font-semibold">Shifokor topilmadi ❌</p>
      </div>
    );
  }
  ...
  const handleBooking = () => {
    if (selectedDate && selectedTime) {
      alert(`Qabul muvaffaqiyatli band qilindi!\nSana: ${selectedDate}\nVaqt: ${selectedTime}\nDoktor: ${doctor.name}`);
    } else {
      ...
      <div className="bg-linear-to-r from-indigo-600 to-blue-500 text-white">
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-2 gap-8 items-center px-6 py-12">
          ...
          <div className="relative">
            <img
              src={doctor.image || "https://images.unsplash.com/photo-1537368910025-700350fe46c7"}
              alt={doctor.name}
            ...
            {doctor.clinic && (
              <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-2 rounded-lg">
                ...
                <p className="font-semibold text-blue-600">{doctor.clinic.name}</p>
              </div>
            )}
          </div>
        </div>
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-6 py-10 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow p-6">
            <h2 className="font-bold text-2xl mb-4 text-gray-800">Shifokor haqida</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              {doctor.bio || "Ushbu shifokor ko'p yillik tajribaga ega, minglab muvaffaqiyatli davolashlar o'tkazgan mutaxassis. Bemor bilan individual ishlash — asosiy tamoyil."}
            </p>
          ...
          <div className="bg-white rounded-xl shadow p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="font-semibold text-xl text-gray-800">Sertifikatlar</h2>
              <button 
            ...
            <div className="space-y-3">
              {(showAllCertificates ? doctor.certificates : doctor.certificates?.slice(0, 3))?.map((certificate, index) => (
                <div key={index} className="flex gap-3 items-start p-3 border rounded-lg hover:bg-gray-50 transition">
          ...
          {doctor.socials && (
            <div className="bg-white rounded-xl shadow p-6">
              <h3 className="font-semibold text-xl mb-4 text-gray-800">Ijtimoiy tarmoqlar</h3>
          ...
          <div className="bg-white rounded-xl shadow p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-semibold text-xl text-gray-800">Statistika</h3>
            </div>
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="text-center p-4 bg-blue-50 rounded-xl">
                <p className="text-3xl font-bold text-blue-600">{doctor.rating}</p>
                <p className="text-gray-600">O'rtacha baho</p>
              </div>
              <div className="text-center p-4 bg-purple-50 rounded-xl">
                <p className="text-3xl font-bold text-purple-600">{doctor.experience}</p>
          ...
          <div className="bg-white rounded-xl shadow p-6">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="font-semibold text-xl text-gray-800">Bemorlar fikri va baholashlar</h3>
                <p className="text-gray-500 text-sm mt-1">{doctor.reviews?.length || 0} ta sharh</p>
              </div>
            ...
            <div className="flex items-center gap-4 mb-6 p-4 bg-gray-50 rounded-xl">
              <div className="text-center">
                <div className="text-4xl font-bold text-indigo-600">{doctor.rating}</div>
              ...
              <div className="flex-1">
                <p className="text-gray-700">Doktor <span className="font-semibold">{doctor.name}</span> bemorlar tomonidan {doctor.rating} ball bilan baholangan.</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {doctor.reviews?.map((review, index) => (
                <div key={index} className="border rounded-xl p-4 hover:shadow-sm transition">
          ...
          <div id="booking-section" className="bg-white rounded-xl shadow p-6">
            <h3 className="font-semibold text-xl mb-6 text-gray-800">Online qabulga yozilish</h3>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="mb-4">
                  <label className="block mb-2 text-sm font-medium text-gray-700">Telefon raqam</label>
                  <input 
                    type="tel" 
                ...
                <div className="mb-4">
                  <label className="block mb-2 text-sm font-medium text-gray-700">Sana tanlang</label>
                  <input 
                    type="date" 
                    value={selectedDate}
              ...
              <div>
                <label className="block mb-2 text-sm font-medium text-gray-700">Vaqt oralig'i</label>
            ...
            {/* Additional Info */}
            <div className="mt-6">
              <label className="block mb-2 text-sm font-medium text-gray-700">Qo'shimcha ma'lumot (ixtiyoriy)</label>
              <textarea 
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow p-6 sticky top-24">
            <h3 className="font-semibold text-lg mb-4 text-gray-800">Kontakt ma'lumotlari</h3>
            ...
            <div className="flex gap-3 items-center mb-4 p-3 bg-blue-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-blue-600 font-semibold">{doctor.phone || "+998 90 000 00 00"}</p>
              </div>
            </div>
            ...
            <div className="flex gap-3 items-center mb-6 p-3 bg-green-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">{doctor.schedule || "Du - Ju / 09:00 – 17:00"}</p>
              </div>
            </div>
            ...
            <div className="border-t pt-4">
              ...
              <div className="mt-4 space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">Keyingi konsultatsiyalar</span>
            ...
            <button className="mt-3 w-full border border-indigo-600 text-indigo-600 py-3 rounded-xl font-semibold hover:bg-indigo-50 transition">
          ...
          <div className="bg-white rounded-xl shadow p-6">
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center gap-3 p-3 border rounded-lg hover:bg-gray-50 transition">
